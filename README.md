...
MCUのクアドラチャモードにおいてパルスをカウントする中で、廉価モーターのインクリメントに異常な増加  
が見られた為、ロジックアナライザーで確認した。結果、廉価モーターにはパルスの乱れが生じている  
ことが判明し、評価対象モーターを交換した。  
#### 廉価モーター  
<p align="center">
...
<p align="center">
  <em>
    6750ms付近に見られるようなパルスの乱れがランダムに発生する。<br>
  </em>
</p>
...
<p align="center">
  <em>
    廉価モーターに見られるような波形の乱れは見られず、<br>
    デューティ比を変化させても波形は一定間隔を保っているため、評価可とした。
  </em>
</p>
