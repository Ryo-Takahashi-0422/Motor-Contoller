...
bool R_PG_Timer_Set_MTU_U0_C0(void)
{
	...
	parameters.data2 = PDL_MTU2_MODE_PWM2 | PDL_MTU2_SYNC_DISABLE;
	parameters.data3 = PDL_MTU2_CLK_PCLK_DIV_64 | PDL_MTU2_CLK_RISING | PDL_MTU2_CLEAR_TGRA;
	parameters.data4 = PDL_MTU2_ADC_TRIG_TGRA_DISABLE;
	parameters.data5 = PDL_MTU2_BUFFER_AC_DISABLE | PDL_MTU2_BUFFER_BD_DISABLE | PDL_MTU2_BUFFER_EF_DISABLE;
	parameters.data6 = PDL_MTU2_A_OC_DISABLED | PDL_MTU2_B_OC_HIGH_CM_LOW;
	parameters.data7 = PDL_MTU2_C_OC_DISABLED | PDL_MTU2_D_OC_DISABLED;
	parameters.data9 = 0;
	parameters.data10 = 7499;
	parameters.data11 = 0;
	parameters.data12 = 0;
	parameters.data13 = 0;
	parameters.data14 = 0;
	...
	parameters.data17 = 0;
	parameters.data18 = 0;
	parameters.func1 = Mtu0IcCmAIntFunc;
